...
#     stream = StringIO.new("2012-01-31 10:52: Arrived\n" <<
#                           "2012-01-31 10:59: Writing a test\n")
#     timelog = Timelog::Timelog.new(stream)
...
#   # Timelog#record_activity writes the specified description to the activity
...
#   # format.  An explicit Time timestamp can optionally be provided.
...
#   # occur on different days.  A new days starts at 4am.
...
#   # Timelog#record_activity writes a blank line to separate activities that
#   # occur on different days.  Day change detection works correctly when more
#   # than 24 hours has passed since the last activity.
